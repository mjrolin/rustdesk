...
lazy_static::lazy_static! {
    pub static ref ORG: RwLock<String> = RwLock::new("Open Time Tecnoligia".to_owned());
}
...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("Open Desk".to_owned());
...
pub const LINK_DOCS_HOME: &str = "https://Open Desk.com/docs/en/";
pub const LINK_DOCS_X11_REQUIRED: &str = "https://Open Desk.com/docs/en/manual/linux/#x11-required";
pub const LINK_HEADLESS_LINUX_SUPPORT: &str =
    "https://github.com/Open Desk/Open Desk/wiki/Headless-Linux-Support";
lazy_static::lazy_static! {
    pub static ref HELPER_URL: HashMap<&'static str, &'static str> = HashMap::from([
        ("Open Desk docs home", LINK_DOCS_HOME),
        ("Open Desk docs x11-required", LINK_DOCS_X11_REQUIRED),
        ("Open Desk x11 headless", LINK_HEADLESS_LINUX_SUPPORT),
        ]);
}
